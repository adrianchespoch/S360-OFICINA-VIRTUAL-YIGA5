...
const TempAuth: React.FC = () => {
    ...
    useEffect(() => {
      ...
      const authLogin = async (): Promise<void> => {
        ...
        try {
          const response: Response = await fetch(`${import.meta.env.VITE_API_ERP}/auth/login/`, requestOptions);
          ...
          if (data?.message === "Inicio de sesión exitoso") {
            ...
            const response2: Response = await fetch(`${import.meta.env.VITE_API_ERP}/preventa/free-sales-filters/${uuid}/`, requestOptions2);
    ...
    contrato ? "Contrato Aceptado" : <UploadDocumentation dataPreventa={preventa} token={token}/> 
    ;
};
